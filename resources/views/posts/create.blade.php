  ...
  <div class="p-8 bg-teal-200 rounded shadow-lg">
    <form method="POST" action="/posts">
      ...
      <label class="block" for="title">
        ...
        <input id="title" class="form-input block w-full mt-2" type="text" name="title" required />
      </label>
      <label class="block mt-4" for="blogBody">
        <span class="uppercase text-sm font-bold">Blog Body</span>
        <textarea id="blogBody" class="form-textarea block w-full mt-2" name="body" rows="10"></textarea>
      </label>
      <label class="block mt-4" for="blogTags">
        ...
        <input id="tags" class="form-input block w-full mt-1" type="text" name="blogTags" />
      </label>
